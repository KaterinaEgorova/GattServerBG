...
namespace SDKTemplate
{
    ...
    public class Constants
    {
        ...
        public static readonly GattLocalCharacteristicParameters gattOperand1Parameters = new GattLocalCharacteristicParameters
        {
        ...
        public static readonly GattLocalCharacteristicParameters gattOperand2Parameters = new GattLocalCharacteristicParameters
        {
            CharacteristicProperties = GattCharacteristicProperties.Write |
                                       GattCharacteristicProperties.WriteWithoutResponse,
            WriteProtectionLevel = GattProtectionLevel.Plain,
        ...
        //public static readonly Guid CalcServiceUuid = Guid.Parse("caecface-e1d9-11e6-bf01-fe55135034f1");
        public static readonly Guid CalcServiceUuid = Guid.Parse("0000FEED-0000-1000-8000-00805f9b34fb");
